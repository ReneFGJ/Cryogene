...
// INÍCIO DA ÁREA DE CONFIGURAÇÃO
    ...
    $agencia = '0098'; // 4 posições
    $conta = '20677';  // 5 posições sem dígito
    $carteira = '176'; // A sem registro é 175 para o Itaú
    $moeda = '9'; // Sempre será 9 pois deve ser em Real
    $nossonumero = '01014570'; // Número de controle do Emissor (pode usar qq número de até 8 digitos);
    $data = '05/03/2005'; // Data de emissão do boleto
	$vencimento = '27/09/2007'; // Data no formato dd/mm/yyyy
	$valor = '27.00'; // Colocar PONTO no formato REAIS.CENTAVOS (ex: 666.01)
