...
array_push($cp,array('$Q cc_nome:cc_codigo:select * from conta_corrente where cc_ativo=1 order by cc_nome','cr_cc','Recebido',False,True,''));
...
<TABLE class="lt1">
<TR><TD align="right">valor original</TD><TD class="lt4"><B><?=numberformat_br($dd[1],2)?></B></TD></TR>
<?
	for ($k=0;$k<99;$k++)
		{
		if (isset($cp[$k]))
