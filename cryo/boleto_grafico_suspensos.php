...
////////////////////////////// Boletos Quitados
$sql = "update cr_boleto set bol_status='S' where (bol_status isnull) or (length(trim(bol_status))=0) ";
$rlt = db_query($sql);
...
$sql = "select * from cr_boleto where bol_status = 'S' order by bol_data_vencimento";
$rlt = db_query($sql);
