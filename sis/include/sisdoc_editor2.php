...
if ($mostar_versao == True) { array_push($sis_versao,array("sisDOC (Editor)",'0.0e',20080717)); }
for ($kz=0;$kz < 100;$kz++)
	{
	$idv ="dd".$kz;
	$ids = trim($vars[$idv]);
//	echo '<BR>['.$idv.'] == '.$vars[$idv];
	if (substr($ids,0,6)=='#flip#')
		{
//		echo '<BR>==>'.$ids;
		$idv = substr($ids,6,10);
//		echo '<HR>';
...
//		echo $tts.'<HR>';
		...
		$tts = troca($tts,"<i",'¢I£<x');
		$tts = troca($tts,"<b",'¢B£<x');
		$tts = troca($tts,"text-decoration: underline",'>¢U£<x');
		$tts = troca($tts,"&nbsp;"," ");
		$tts = troca($tts,"</i",'¢/I£<x');
		$tts = troca($tts,"</span>q",'¢/U£<x');
		$tts = troca($tts,"</b",'¢/B£<x');
		$tts = ' '.$tts;
		while (strpos($tts,'<') > 0 )
			{
			$tts = trim($tts);
			$tti=substr($tts,0,strpos($tts,'<'));
			$ttf=substr($tts,strpos($tts,'<'),strlen($tts));
			$ttf=substr($ttf,strpos($ttf,'>')+1,strlen($ttf));
			$tts = ' '.$tti.$ttf;
			}
		$tts = troca($tts,'¢U£','<span style="text-decoration: underline;" >');
		$tts = troca($tts,'¢','<');
		$tts = troca($tts,'£','>');
		$dd[$kz] = $ttz;
		//echo $dd[$kz];
...
//---------------------------------------------------------------------------------------------------------
  ...
  this.fieldName = "dde";                  // default field name
...
//---------------------------------------------------------------------------------------------------------
  ...
  this.insertBullet = function() {
    var html = '<table border=0 cellspacing=0 cellpadding=0><tr><td valign=top><img src="' + this.bulletpoint + '"></td><td>' + txtInsertText + '</td></tr></table>';
    this.pasteSel(html);
  }
  ...
  this.buildEditor = function() {
    ...
    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'cut\')"><img src="<?=$include;?>img/ed_cut.gif" width=16 height=16 alt="' + txtCut + '"></td>');
    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'copy\')"><img src="<?=$include;?>img/ed_copy.gif" width=16 height=16 alt="' + txtCopy + '"></td>');
    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'paste\')"><img src="<?=$include;?>img/ed_colar.gif" width=16 height=16 alt="' + txtPaste + '"></td>');

<?
//    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'justifyLeft\')"><img src="<?=$include;?!>img/ed_align_l.gif" width=16 height=16 alt="' + txtJustifyLeft + '"></td>');
//    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'justifyCenter\')"><img src="<?=$include;?!>img/ed_align_c.gif" width=16 height=16 alt="' + txtJustifyCenter + '"></td>');
//    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'justifyRight\')"><img src="<?=$include;?!>img/ed_align_r.gif" width=16 height=16 alt="' + txtJustifyRight + '"></td>');

/*    document.writeln('<td><div style="width:1px; height:15px; border:1px inset"></div></td>');
    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'insertOrderedList\')"><img src="<?=$include;?!>img/ed_ol.gif" width=16 height=16 alt="' + txtOrderedList + '"></td>');
    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'insertUnorderedList\')"><img src="<?=$include;?!>img/ed_ul.gif" width=16 height=16 alt="' + txtUnorderedList + '"></td>');
    document.writeln('<td><div style="width:1px; height:15px; border:1px inset"></div></td>');

    document.writeln('<td><select style="font:menu" onChange="rto[' + this.id + '].fnExec(\'fontName\', this[this.selectedIndex].value); this.selectedIndex=0">' +
...
*/
?>
    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'bold\')"><img src="<?=$include;?>img/ed_bold.gif" width=16 height=16 alt="' + txtBold + '"></td>');
    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'italic\')"><img src="<?=$include;?>img/ed_italico.gif" width=16 height=16 alt="' + txtItalic + '"></td>');
    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'underline\')"><img src="<?=$include;?>img/ed_sublinhado.gif" width=16 height=16 alt="' + txtUnderline + '"></td>');
    document.writeln('<td><div style="width:1px; height:15px; border:1px inset"></div></td>');
    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'undo\')"><img src="<?=$include;?>img/ed_undo.gif" width=16 height=16 alt="' + txtUndo + '"></td>');
    document.writeln('<td class="cssBtnBar' + this.id + '" width=20 height=20 onMouseOver="this.className=\'cssRaised' + this.id + '\'" onMouseOut="this.className=\'cssBtnBar' + this.id + '\'" onMouseDown="this.className=\'cssPressed' + this.id + '\'" onMouseUp="this.className=\'cssRaised' + this.id + '\'" onClick="rto[' + this.id + '].fnExec(\'redo\')"><img src="<?=$include;?>img/ed_redo.gif" width=16 height=16 alt="' + txtRedo + '"></td>');
